...
function renderToNodeStreamImpl(children, options, generateStaticMarkup) {
  ...
  const request = createRequest(children, createResponseState$1(false, options ? options.identifierPrefix : undefined), createRootFormatContext(), Infinity, onError$1, onAllReady, undefined, undefined);
